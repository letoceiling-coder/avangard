import{_ as e,c as s,a as i,F as g,q as a,o as r,p as d,t as p}from"./admin--_dpiEdI.js";const c={name:"Documentation",data(){return{activeSection:"overview",sections:[{id:"overview",title:"Обзор системы"},{id:"api",title:"API Endpoints"},{id:"admin",title:"Админ-панель"},{id:"deployment",title:"Деплой"}],documentation:{overview:`
                    <h2>Обзор системы</h2>

...
class UpdateCommercialPremiseRequest extends FormRequest
{
    /**
    ...
    {
        $premiseId = $this->route('commercialPremise')->id ?? null;
        ...
        return [
            ...
            'guid' => ['sometimes', 'required', 'string', 'max:255', Rule::unique('commercial_premises', 'guid')->ignore($premiseId)],
